...
(C) $\mathbb{P}(X > Y)$.
----------------------------------------------------------------------------
Como $X$ y $Y$ son independientes e identicamente distribuidas, entonces $X-Y$ es simétrica (veasé **[Pregunta 16.5.](https://austriamax.github.io/austriamax.proba1.github.io/P16_5.html)**).
