...
De acuerdo con el razonamiento escrito en **[Pregunta 14.1.](https://austriamax.github.io/austriamax.proba1.github.io/P14_1.html)** tenemos que:
...
&\implies \{\omega \in \mathbb{N}:|X(\omega)|>a_n\} \supseteq \{\omega \in \mathbb{N}:|X(\omega)|>a_m\}\\\\
& \implies 1_{\{\omega \in \mathbb{N}:|X(\omega)|>a_n\}} \geq 1_{\{\omega \in \mathbb{N}:|X(\omega)|>a_m\}}\\\\
&\implies \{\omega \in \Omega : |X(\omega)|^q 1_{\{\omega \in \mathbb{N}:|X(\omega)|>a_n\}} \geq \epsilon\} \supseteq \{\omega \in \Omega: |X(\omega)|^q1_{\{\omega \in \mathbb{N}:|X(\omega)|>a_m\}} \geq \epsilon\}\\\\
...
Por definición
\[Y_n > a_n1_{\{\omega \in \mathbb{N}:|X(\omega)|>a_n\}}\]
entonces
\[\mathbb{E}[Y_n] \geq a_n\mathbb{P}[{\{\omega \in \mathbb{N}:|X(\omega)|>a_n\}}]\]
