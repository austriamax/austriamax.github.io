...
Utilizarémos el siguiente teorema presente en el libro "Measure and Probability Theory de Altheyra", pg. 30.  **[TEOREMA](https://austriamax.github.io/austriamax.proba1.github.io/P10_3_Teorema.html)**
...
\[\lambda^*(J_n) = \lambda^*(Q_n \cap A_n) + \lambda^*(Q_n - A_n) = \lambda^*(A_n) + \lambda^*(Q_n - A_n)\]
