...
En la demostración mostraremos que el conjunto de conjuntos $S \subseteq \mathscr{B}(\mathbb{R})$ que cumplen la propiedad que nos interesa es una $\sigma$-álgebra que contiene a los intervalos $(a,b]$ (y por lo tanto a $\mathscr{B}(\mathbb{R})$).

Sea \[S = \{A \in \mathscr{B}(\mathbb{R})|\mbox{ } \forall \epsilon>0 \mbox{ } \exists C,U \subseteq \mathbb{R} \mbox{ tal que } C \subseteq A \subseteq U \mbox{ con } C \mbox{ cerrado y } U \mbox{ abierto}\}.\]


  1.1) PD. $S$ es una $\sigma$-álgebra.
...
\end{align*}
  ...
  Así, existen $(U_n)_{n\in \mathbb{N}}$ una familia de abiertos y $(C_n)_{n\in \mathbb{N}}$ tales que
  ...
  Donde $\cup_{n \in \mathbb{N}} C_n$ no necesariamente es cerrado pero $\cup_{n \in \mathbb{N}} U_n$ es abierto.

Por la continuidad de la medida $\exists N \in \mathbb{N}$ tal que 

\[\lambda(\cup_{n = 1}^\infty C_n - \cup_{n = 1}^N C_n) \leq \frac{\epsilon}{3}.\]

Donde sabemos que $\cup_{n = 1}^N C_n$ es cerrado (por ser union finita de cerrados). Así proponemos
...
\[C \subseteq \cup_{n=1}^\infty A_n \subseteq U\]

Con $C$ es cerrado y $U$ abierto (union arbitraria de abiertos es abierto).


Ahora sólo falta ver la condición de la medida. Notemos dos cosas:

  (c.1) $\lambda(U - \cup_{n \in \mathbb{N}}C_n) \leq \frac{\epsilon}{2}$
...
\end{align*}
  ...
  (c.2) \[U-C = (U-\cup_{n \in \mathbb{N}}C_n) \cup [U\cap(\cup_{n \in \mathbb{N}}C_n - C)]\]
  
  Es decir, sólo partimos la $U-C$ en lo que nunca se iba quitar $(U-\cup_{n \in \mathbb{N}}C_n)$ y la parte que en algun momento se iba quitar $[U\cap(\cup_{n \in \mathbb{N}}C_n - C)$.
  
  Así
  
  \begin{align*}
\lambda(U - \cup_{n \in \mathbb{N}}C_n) &= \lambda[(U-\cup_{n \in \mathbb{N}}C_n) \cup [U\cap(\cup_{n \in \mathbb{N}}C_n - C)]\\\\
&\leq \lambda(U-\cup_{n \in \mathbb{N}}C_n) + \lambda[U\cap(\cup_{n \in \mathbb{N}}C_n - C)] \\\\
&= \frac{\epsilon}{2} + \lambda[U\cap(\cup_{n \in \mathbb{N}}C_n - C)] \\\\
&\leq \frac{\epsilon}{2} + \lambda[(\cup_{n \in \mathbb{N}}C_n - C)] && (\mbox{pues } U\cap(\cup_{n \in \mathbb{N}}C_n - C) \subseteq (\cup_{n \in \mathbb{N}}C_n - C))\\\\
...
Es decir, $S$ es una $\sigma$-álgebra.
  ...
  1.2) PD. $S$ contiene a los intervalos de la forma $(a,b] \subset \mathbb{R}$.
...
Como $\mathscr{B}(\mathbb{R})$ es la mínima $\sigma$-álgebra que contiene a los intervalos $(a,b]$ entonces 
